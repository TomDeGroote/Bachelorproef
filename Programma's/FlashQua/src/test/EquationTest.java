...
public class EquationTest {
	...
	public void equalEquationTest() {
		...
		part1.add(new Sum());
		part1.add(new Terminal("K0", 5.0));
		part1.add(new Multiplication());
		part1.add(new Terminal("W3", 3.0));
		List<Symbol> part2 = new ArrayList<Symbol>();
		part2.add(new Sum());
		part2.add(new Terminal("K1", 6.0));
		parts1.add(part1);
		parts1.add(part2);
		...
		part3.add(new Sum());
		part3.add(new Terminal("K1", 6.0));
		List<Symbol> part4 = new ArrayList<Symbol>();
		part4.add(new Sum());
		part4.add(new Terminal("K0", 5.0));
		part4.add(new Multiplication());
		part4.add(new Terminal("W3", 3.0));
		parts2.add(part3);
		parts2.add(part4);
		
		Equation eq1 = new Equation(new Terminal("Fuck", 2.0));
		eq1.value = 31.0;
		eq1.nonSplitableParts = parts1;
		
		Equation eq2 = new Equation(new Terminal("Fuck", 2.0));
		eq2.value = 31.0;
