...
public class GrammarTest {
	...
	public void getValueTest() {
		Assert.assertEquals(true, 5.0 == new DoubleEvaluator().evaluate(4.0 + new Operand("+", true, true).toString() + 1.0));
		Assert.assertEquals(true, 4.0 == new DoubleEvaluator().evaluate(4.0 + new Operand("*", true, true).toString() + 1.0));
		Assert.assertEquals(true, 4.0 == new DoubleEvaluator().evaluate(4.0 + new Operand("/", true, true).toString() + 1.0));
		Assert.assertEquals(true, 3.0 == new DoubleEvaluator().evaluate(4.0 + new Operand("-", true, true).toString() + 1.0));
	}
	
	@Test
	public void getValue2Test() {
		Assert.assertEquals(true, 5.0 == Grammar.getValue(4.0, new Operand("+", true, true), 1.0));
		Assert.assertEquals(true, 4.0 == Grammar.getValue(4.0, new Operand("*", false, true), 1.0));
		Assert.assertEquals(true, 2.0 == Grammar.getValue(4.0, new Operand("/", false, false), 2.0));
		Assert.assertEquals(true, 4.0 == Grammar.getValue(5.0, new Operand("-", true, false), 1.0));
	}
