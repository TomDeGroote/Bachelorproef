...
\begin{abstract}
  Bij het zoeken naar een geschikte vergelijking voor gegeven voorbeelden kunnen er optimalisaties gemaakt worden.
  Met de voorgestelde optimalisaties kan er tot 33.333\% aan snelheid gewonnen worden en de kans op het vinden van een oplossing neemt des ondanks toe.
\end{abstract}
